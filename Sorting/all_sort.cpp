 ...
 *Shubham kumbhar guided by Suraj Subramanian 
 */
...
//calling selection sort
    ...
    cout<<"Execution Time for selection sort is : "<<cpu_time_used<<endl;
...
//calling insertion sort
    ...
    stop=clock();
    cpu_time_used = ((double)(stop-start))/CLOCKS_PER_SEC;
    cout<<"Execution Time for insertion sort is : "<<cpu_time_used<<endl;
...
// calling merge sort
    ...
    stop=clock();
    cpu_time_used = ((double)(stop-start))/CLOCKS_PER_SEC;
    cout<<"Execution Time for merge sort is : "<<cpu_time_used<<endl;
...
//calling QUICK SORT
    ...
    stop=clock();
    cpu_time_used = ((double)(stop-start))/CLOCKS_PER_SEC;
    cout<<"Execution Time for Quick sort is : "<<cpu_time_used<<endl;
